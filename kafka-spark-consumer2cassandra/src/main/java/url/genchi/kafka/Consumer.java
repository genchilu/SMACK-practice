...
public class Consumer {
    public static void main(String[] argv) throws Exception{
        ...
        kafkaParams.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,"192.168.99.111:9092");
        ...
        wordCount.foreachRDD(rdd -> {
            CassandraJavaUtil.javaFunctions(rdd).writerBuilder("test", "wordcount", mapTupleToRow(String.class, Integer.class)).saveToCassandra();
        });
